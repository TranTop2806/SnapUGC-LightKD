...
function renderResult(data) {
  ...
  const autoRows = visualPost.length
    ? visualPost
    : ["Auto edit sẽ chỉ áp dụng các chỉnh sửa hình ảnh nhẹ nếu tìm thấy clip phù hợp; metadata cần chỉnh thủ công."];
            ...
            return `
              <article class="concept">
                <div class="concept-top">
                  ...
                  <span class="concept-score">${escapeHtml(concept.label_vi || concept.label || "")}</span>
                </div>
                <div class="concept-bar"><span style="width: ${score * 100}%"></span></div>
