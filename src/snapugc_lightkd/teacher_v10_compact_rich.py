"""Teacher v10: compact rich-input teacher.

Unlike v8, this version keeps seven modality tokens by folding:
  - YAMNet embedding + AudioSet probabilities into one audio token
  - DOVER scores + numeric metadata into one quality/context token
"""
...
class TeacherV10CompactRich(nn.Module):
    """V3-shaped teacher that consumes richer inputs without extra tokens."""
