"""Teacher v4: shared-text compact teacher.

This version attacks text redundancy. Metadata, caption, and rationale share one
projection and are pooled into one text-summary token, reducing seven modality
tokens to five.
"""
...
class TeacherV4SharedText(nn.Module):
    """Compact teacher with a shared text encoder and five fusion tokens."""
    ...
    def __init__(
        ...
        self.modality_embed = nn.Parameter(torch.zeros(1, 5, hidden_dim))
    ...
    def _regularize_text_inputs(self, caption_emb, rationale_emb, quality_scores):
    ...
    def forward(
        ...
        caption_emb, rationale_emb, quality_scores = self._regularize_text_inputs(
